...
const SEED_POSTS = [
    ...
    },
    {
        ...
        handle: '@dev003',
        avatar: '🐣',
        content: 'Day 3 of learning kdb+/q. I typed `10?100` and got 10 random numbers. In Python that\'s `import random; [random.randint(0,100) for _ in range(10)]`. Why did nobody tell me about this earlier?',
        timestamp: '6h ago',
        likes: 67,
        replies: 8,
        reposts: 15,
    ...
    },
    {
        ...
        handle: '@dev004',
        avatar: '📈',
        content: 'Built a tick data capture system in kdb+/q today. The entire feedhandler + logging + historical database persistence fits in ~40 lines. Try doing that in Java. 😂',
        timestamp: '8h ago',
        likes: 31,
        replies: 4,
        reposts: 6,
